...
const ChallengeModal: React.FC<ChallengeModalProps> = ({ isOpen, message, onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[100] backdrop-blur-sm">
      <div className="bg-white p-8 rounded-2xl shadow-2xl max-w-md w-full text-center border-4 border-yellow-400">
        ...
        <h2 className="text-3xl font-black text-yellow-600 mb-2 font-display">Tantangan !</h2>
        ...
        <div className="flex gap-4">
          {/* Tombol tutup: ketika ditekan, gameplay akan ganti giliran ke player berikutnya */}
          <button 
            onClick={() => onComplete()}
